...
function EmbeddableHeader(props) {
  const maxStep = Math.min(
    props.stepIndex + 1,
    props.embedWidgetSteps ? props.embedWidgetSteps.length : 1
  );
  return (
    <div className="embeddable-booking-header">
      <div className="is-full-width">
        <div className="">
          <div className="large-title has-text-left">{props.headerText}</div>
        </div>
        <div className="embedded-view mobile-nav">
          <div className="step-header">
            ...
            <div className="mobile-nav-header">
              <div className="instruction is-fullwidth">
                {props.embedWidgetSteps &&
              ...
              <div className="progress is-fullwidth">
                Step {maxStep} of{" "}
                {props.embedWidgetSteps ? props.embedWidgetSteps.length : null}
              </div>
            </div>
