...
function ContactInfoForm(props) {
  ...
  const onSubmit = async (values) => {
    ...
    return axios
      .post(`${connection.backend}/api/v2/bookings/complete_booking.json`, {
        ...values,
        date: slot.date,
      ...
      <Form
        ...
        render={({ handleSubmit, submitting }) => (
          <form className="contact-information-form" onSubmit={handleSubmit}>
            <div className="embedded-main-title">Contact Information</div>
                ...
                render={({ input, meta }) => (
                  <div className="field">
                    ...
                    <div className="control">
                      <input
                        className="input"
                        placeholder={"Ex. alice.smith@example.com"}
                        {...input}
                      />
                    </div>
                    {meta.touched && meta.error && (
            ...
            {props.selectedContactType ? (
              <div className="field">
                ...
                <div className="control">{props.selectedContactType}</div>
              </div>
            ) : null}
            ...
            <div style={{ margin: "20px 0px" }}>
              <div className="has-text-centered">
                <button
                  className={`sw-button primary-button is-relative continue-button ${
