...
import com.minsa.sanama.model.rrhh.HorarioAtencion;
...
public class HorarioAtencionRepository {
    ...
    private final HorarioAtencionMappper horarioAtencionMappper = new HorarioAtencionMappper();
    ...
    private static class EnfermeraMapper implements RowMapper<Enfermera> {
        ...
        public Enfermera mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            enfermera.setFechaNacimiento(rs.getDate("fecha_nacimiento"));
