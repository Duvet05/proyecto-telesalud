...
import { default as SuccessIcon } from "@/components/icons/_SuccessIcon";
import { default as LocationOnMapIcon } from "@/components/icons/_LocationOnMapIcon";
import { default as CalendarSheetIcon } from "@/components/icons/_CalendarSheetIcon";
import { default as ClockIcon } from "@/components/icons/_ClockIcon";
import { default as LocationSpotIcon } from "@/components/icons/_LocationSpotIcon";

function CompletedBookingInfo(props) {
  ...
  return (
    <div className={`embedded-confirmation-container ${subContainerClasses}`}>
      ...
      {isAppointment ? (
        <>
          <div className="embeded-confirmation-message">You’re booked!</div>
          ...
          <div className="embedded-items-container">
            ...
            <div className="embedded-item">
              <ClockIcon
                ...
                opacity="1"
              />
              {format(toDate(appointment.start), "h:mm")} -{" "}
              {format(toDate(appointment.end), "h:mm a (z)")}
            </div>
            <div className="embedded-item">
              <LocationSpotIcon />
